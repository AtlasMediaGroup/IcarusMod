...
@CommandParameters(name="dellogin",description="Remove your custom login message.",usage="/dellogin <message>",rank=ICM_Rank.Rank.SUPER)
public class Command_dellogin
{
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args)
    {
        ...
        try
        {
            PreparedStatement statement = ICM_SqlHandler.getConnection().prepareStatement("DELETE FROM `players` WHERE `loginMessage` = ? WHERE `playerName` = ?");
