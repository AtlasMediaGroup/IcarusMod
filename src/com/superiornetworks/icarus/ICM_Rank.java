...
public class ICM_Rank
{
    ...
    public enum Rank
    {
        ...
        IMPOSTER(-1, "Imposter", "§e[IMP]"), NONOP(0, "Non-Op", "§c[Non-Op]"), OP(0, "Op", "§c[Op]"), SUPER(1, "Super Admin", "§b[SA]"), TELNET(2, "Telnet Admin", "§&2[STA]"), SENIOR(3, "Senior Admin", "§d[SrA]"), DEVELOPER(4, "Developer", "§5[Dev]"), MANAGER(5, "Manager", "§4[MgR]");
